  ...
  <div class="orders">
    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div v-if="submittedOrders.length === 0" class="empty-submitted">
          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                  ...
                  <details class="items-details">
                    ...
                    <div class="items-dropdown">
                      <div v-for="item in order.items" :key="item.item_sku" class="item-entry">
                        ...
                        <span class="item-meta">{{ t('orders.quantity') }}: {{ item.quantity }} @ {{ formatCurrency(item.unit_cost, currentCurrency.value) }}</span>
                      </div>
                    </div>
                  </details>
                </td>
                ...
                <td class="col-value"><strong>{{ formatCurrency(order.total_value, currentCurrency.value) }}</strong></td>
              </tr>
            </tbody>
          </table>
        </div>
